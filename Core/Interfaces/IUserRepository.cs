...
namespace Core.Interfaces
{
    public interface IUserRepository
    {
        ...
        Task<IEnumerable<dynamic>> GetUsersAgenda();
        Task<IEnumerable<dynamic>> GetUserAgenda(string usuario);
        ...
        Task<IEnumerable<dynamic>> InsertUserAgenda(string usuario, string clave, string nombres, string apellidos, string rucEmpresa, string email);
